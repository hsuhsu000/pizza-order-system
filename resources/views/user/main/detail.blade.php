...
<div class="container-fluid pb-5">
    <div class="row px-xl-5">
        <div class="col-lg-4 mb-30">
            ...
            <a href="{{ route('user#home') }}" class="text-dark"><i class="fa-solid fa-arrow-left-long"> </i> Back</a>
        ...
        <div class="col-lg-8 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <button class="btn btn-primary px-3" type="submit" id="addCartBtn"><i class="fa fa-shopping-cart mr-1"></i> Add To
                        Cart</button>
                </div>
